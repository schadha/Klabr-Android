<<<<<<< HEAD:src/com/klabr_android/SearchActivity.java
			...
			public void onClick(View v) {
			    ...
			    try {
					...
					if (results.length() > 0)
					{
						...
						((JSONObject)results.get(i)).getString("vicinity").substring(0, ((JSONObject)results.get(i)).getString("vicinity").indexOf(",")) + ")");
...
>>>>>>> FETCH_HEAD:src/com/collabhawk_android/SearchActivity.java
